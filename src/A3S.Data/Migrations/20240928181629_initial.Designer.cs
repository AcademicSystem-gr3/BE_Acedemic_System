...
namespace A3S.Data.Migrations
{
    ...
    [Migration("20240928181629_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("A3S.Core.Domain.Entities.Document", b =>
                {
                    ...
                    b.HasIndex("UserId", "SubjectName");

                    b.ToTable("Documents");
                });

            modelBuilder.Entity("A3S.Core.Domain.Entities.DocumentShare", b =>
                {
            ...
            modelBuilder.Entity("A3S.Core.Domain.Entities.StudentSubject", b =>
                {
                    b.Property<Guid>("SubjectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SubjectId", "StudentID", "TeacherID");
            ...
            modelBuilder.Entity("A3S.Core.Domain.Entities.StudentSubject", b =>
                {
                    b.HasOne("A3S.Core.Domain.Identity.User", "Student")
